    ...
    return [
      {
        ...
        headers: [
          ...
          // Content Security Policy — bloquea XSS, clickjacking e inyección
          // de recursos. 'unsafe-inline' en script-src es necesario por Next.js
          // (inline scripts del runtime). 'unsafe-eval' por hot-reload en dev.
          {
