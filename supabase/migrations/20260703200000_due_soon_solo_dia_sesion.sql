-- Aviso interno "Factura por vencer" (invoice_due_soon) solo el DÍA de la sesión.
-- Antes disparaba cuando due_date estaba dentro de los próximos 3 días
-- (i.due_date between current_date and current_date+3) → adelantaba el aviso.
-- Ahora: i.due_date = current_date (el día del evento, que es cuando vence).
-- (El paso 0 "vencida" ya quedó bien en la migración 20260703190000.)
